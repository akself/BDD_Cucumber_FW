package com.dca.listener;

/**
 * Created by Mahendra.Singh on 8/4/2017.
 */
...
public class Reporter {
    ...
    public static void loadXMLConfig(File file) {
        getExtentHtmlReport().loadXMLConfig("extent-config.xml");
    }
     ...
     * @throws IOException Exception if imagePath is erroneous
     */
    /*public static void addScreencastFromPath(String screenCastPath) throws IOException {
